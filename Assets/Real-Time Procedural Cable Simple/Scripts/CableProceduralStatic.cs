...
public class CableProceduralStatic : MonoBehaviour
{
	...
	[SerializeField, Tooltip("Number of points per unit length, using the straight line from the start to the end transform.")]
	float pointDensity = 0.1f;

	// How much the cable will sag by.
	[SerializeField] float sagAmplitude = 0.5f;
